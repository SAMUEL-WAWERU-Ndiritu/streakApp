...
class ActivityManager {
    ...
    renderActivities() {
        ...
        activitiesContainer.style.flexDirection = "row";
      ...
      <div id="cancel"><ion-icon name="close-circle-outline"></ion-icon></div>
      <img id="id_img" src="${activity.image}" />
       <p data-index="${this.activities.indexOf(activity)}" >${activity.startDate.toLocaleDateString()}</p>
        <h3 data-index="${this.activities.indexOf(activity)}">${activity.name}</h3>
         ...
         <P  class="delete-button">To see the click here </P>
        <button class="update-button"> Streak Note</button>
      `;
